...
| ![image](https://github.com/user-attachments/assets/ebdc6664-2ed2-46d1-acf1-f7a2acc99a5d) | If you clone any of these repos then any 'push' will attempt to push here but you have read only access so it will fail. <br>It is best practice to fork the repo. This will create a copy under your own account. Then you can clone that to your local computer. Or simply download the zip containing the code| ![image](https://github.com/user-attachments/assets/ebdc6664-2ed2-46d1-acf1-f7a2acc99a5d)
| :---: | :------- | :----------- |
...
| Name | Purpose | Notes |
| -- | -- | --|
| [JavaMySQLDemo](https://github.com/NClan-HNC/JavaMySQLDemo) | How to connect to MySQL | Demonstrates insert, query and prepared statements. |
...
| [CurrencyConverter](https://github.com/NClan-HNC/CurrencyConverterSwing) | Simple currency converter. | Uses a few components, also includes Spanish translation |
